...
import { mcpToolsOptimized } from './tools/mcp-tools-optimized.js';
import { UnifiedToolHandlers } from './tools/unified-handlers.js';
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      try {
        ...
        switch (name) {
          ...
          case 'project_ops':
            result = await UnifiedToolHandlers.manageProjectOps(safeArgs);
            break;
          ...
          case 'system_monitor':
            result = await UnifiedToolHandlers.manageSystemMonitor(safeArgs);
            break;
